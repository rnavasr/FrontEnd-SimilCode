...
import { Card, Typography, Tag, Collapse, Badge, Spin } from 'antd';
...
const DetalleComentariosEficienciaGrupalIA = ({ comparacionId }) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const url = buildApiUrlWithId(API_ENDPOINTS.OBTENER_COMENTARIOS_EFICIENCIA_GRUPAL, comparacionId);
                ...
                if (data.existe_comentarios) {
                    setAnalisisData({
                        analisis_completo: {
                            mejor_codigo: data.analisis_comparativo.mejor_codigo,
                            peor_codigo: data.analisis_comparativo.peor_codigo,
                            ranking_ia: data.ranking_ia,
                            resumen_comparativo: data.analisis_comparativo.resumen_comparativo,
                            patrones_eficientes: data.patrones.eficientes,
                            patrones_ineficientes: data.patrones.ineficientes,
                            recomendaciones_generales: data.recomendaciones_generales
                        },
                        comentarios_individuales: data.comentarios_individuales,
                        respuesta_completa_ia: data.respuesta_completa_ia,
                        estadisticas: {
                            total_codigos_analizados: data.total_comentarios,
...
export default DetalleComentariosEficienciaGrupalIA;