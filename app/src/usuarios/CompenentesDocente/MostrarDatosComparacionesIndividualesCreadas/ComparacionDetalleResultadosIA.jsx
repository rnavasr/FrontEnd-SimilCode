...
const ComparisonDetailResults = ({ resultados, loadingResults }) => {
    ...
    const parsedSections = parseIAResponse(resultados.explicacion);

    return (
        <div className="results-container" style={{ padding: '32px 5px 5px 5px' }}>
...
export default ComparisonDetailResults;